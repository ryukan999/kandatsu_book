...
ActiveRecord::Schema.define(version: 2021_02_06_101141) do
  ...
  create_table "books", id: :serial, force: :cascade do |t|
    ...
    t.bigint "group_id"
    t.string "borrower"
    t.bigint "rental_user_id", comment: "本を借りているユーザー"
    t.index ["group_id"], name: "index_books_on_group_id"
    t.index ["rental_user_id"], name: "index_books_on_rental_user_id"
  ...
  add_foreign_key "books", "users", column: "rental_user_id"
